...
export let introduction = {
  ...
  welcomeText:
    "Ich halte deine schönsten Momente mit meiner Kamera fest. Jedes Foto lebt durch deine Emotionen und Erinnerungen!",
  imageUrl: "img/marta.jpg",
  highlightHeadline: "Berliner Fotografin | Berlin & Umgebung",
  highlightText:
    "Ich halte deine schönsten Momente mit meiner Kamera fest. Jedes Foto lebt durch deine Emotionen und Erinnerungen! Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit.",
...
export let about = {
  quote:
    "Fotografieren bedeutet für mich, Momente mit der Kamera festzuhalten, die vorher unsichtbar waren. Es ist keine Kunst, zu fotografieren… es ist eher die Gabe, Menschen und Situationen mit all ihren Facetten und in ihrer Echtheit zu sehen und diese Emotionen dann für jeden sichtbar zu machen.",
  imageUrl: [
    "img/about/marta_about1.jpg",
    "img/about/marta_about2.jpg",
    "img/about/marta_about3.jpg"
  ],
...
export let pricingFooter = {
  question: "Kein richtiges Paket gefunden?",
...
export let pricingVoucher = {
  ...
  title: "Gutschein",
  question: "Sucht Ihr ein ganz besonderes und persönliches Geschenk für Eure Familie oder Freunde?",
  answer: "Ein Gutschein für ein individuelles Fotoshooting in Berlin ist für jeden genau die richtige Geschenkidee!"
}
...
export let contactData = {
  text:
    "Wenn Du Interesse an meiner Arbeit hast oder auch weitere Informationen wünschst, nimm bitte Kontakt mit mir auf.",
